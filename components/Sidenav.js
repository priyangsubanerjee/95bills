...
function Sidenav() {
  ...
  return (
    <div className="fixed h-screen bg-white w-72 lg:w-60 inset-0 overflow-hidden">
      <div className="h-auto w-72 lg:w-60 bg-slate-50 relative shrink-0 flex flex-col overflow-y-auto">
